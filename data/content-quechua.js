const CONT_Q={
  oraciones:{title:"Oraciones reales",color:"#2dd4bf",pieces:[
    {level:1,type:"Primeras palabras",title:"Las primeras palabras",sub:"Vocabulario esencial",lines:[
      {q:"Ari.",s:"Sí."},
      {q:"Mana.",s:"No."},
      {q:"Allinmi.",s:"Está bien."},
      {q:"Imataq sutiyki?",s:"¿Cómo te llamas?"},
      {q:"Nuqap sutiymi Maria.",s:"Mi nombre es María."},
      {q:"Yusulpayki.",s:"Gracias."},
      {q:"Manan yachanichu.",s:"No sé."}
    ],notes:[{t:"Ari / Mana",d:"Sí / No — las palabras más básicas."},{t:"Yusulpayki",d:"Gracias (del español 'Dios le pague')."},{t:"Manan...chu",d:"Negación: Manan yachanichu = No sé."}]},
    {level:1,type:"Saludos",title:"Rimanakusun",sub:"Conversaciones del día",lines:[
      {q:"Allinllachu kanki?",s:"¿Cómo estás?"},
      ...
      {q:"Paqarinkama.",s:"Hasta mañana."}
    ],notes:[{t:"Allinllachu",d:"¿Estás bien? — saludo cotidiano."},{t:"Kachkani",d:"Estoy (ahora mismo)."},{t:"Paqarinkama",d:"Hasta mañana."}]},
    {level:2,type:"Familia",title:"La familia en los Andes",sub:"Vínculos familiares",lines:[
    ...
    ],notes:[{t:"-y posesivo",d:"Mamay=mi madre. Taytay=mi padre."},{t:"-mi evidencial",d:"Llamkaqmi=trabaja (lo sé de primera mano)."},{t:"Wayk'uy",d:"Cocinar."}]},
    {level:2,type:"Animales",title:"Animales sagrados",sub:"La fauna andina",lines:[
    ...
    ],notes:[{t:"Llama",d:"Animal sagrado de los Andes."},{t:"Kondor",d:"Ave sagrada, mensajero entre mundos."},{t:"-m evidencial",d:"Hechos de primera vista."}]},
    {level:2,type:"Comida",title:"Sabores de la Pachamama",sub:"Alimentación andina",lines:[
    ...
    {level:2,type:"Chakra",title:"La vida en el campo",sub:"Trabajo en la tierra",lines:[
    ...
    {level:2,type:"Música",title:"Takiy kay pacha",sub:"Música y danza andina",lines:[
    ...
    {level:2,type:"Amor",title:"Munakuy",sub:"El amor en las palabras",lines:[
    ...
    {level:3,type:"Vida diaria",title:"Un día en los Andes",sub:"Actividades cotidianas",lines:[
    ...
    {level:3,type:"Naturaleza",title:"La Pachamama habla",sub:"La madre tierra y el cosmos",lines:[
    ...
    {level:3,type:"Emociones",title:"El corazón quechua",sub:"Sentimientos y estados internos",lines:[
    ...
    {level:3,type:"Artesanía",title:"Manos que crean",sub:"Tejido y arte andino",lines:[
    ...
    {level:3,type:"Pacha",title:"Los tiempos del año",sub:"Estaciones y cosmos",lines:[
  ...
  poesia:{title:"Poesía Quechua",color:"#a78bfa",pieces:[
    {level:1,type:"Harawy",title:"Kusikuymi",sub:"Soy feliz",poem:true,lines:[
    ...
    {level:1,type:"Harawy",title:"Sara Harawy",sub:"Canto al maíz sagrado",poem:true,lines:[
    ...
    {level:2,type:"Poema tradicional",title:"Orqo Sonqo",sub:"Corazón de Montaña",poem:true,lines:[
    ...
    {level:2,type:"Poema",title:"Ñan",sub:"El camino",poem:true,lines:[
    ...
    ],notes:[{t:"Ñan",d:"Camino — también el camino de la vida."},{t:"Wiñaypim",d:"Para siempre."}]},
    {level:2,type:"Harawy",title:"Killa Rimarin",sub:"La luna habla",poem:true,lines:[
    ...
    {level:2,type:"Poema moderno",title:"Yakum Rimarin",sub:"El agua habla",poem:true,lines:[
    ...
    {level:3,type:"Poema",title:"Wayra Takiy",sub:"Canto del viento",poem:true,lines:[
    ...
    {level:3,type:"Harawy",title:"Pachamama Hukaylliy",sub:"Alabanza a la Madre Tierra",poem:true,lines:[
  ...
  leyendas:{title:"Leyendas Quechuas",color:"#f59e0b",pieces:[
    {level:1,type:"Fábula",title:"Atuq Achachi",sub:"El zorro astuto",legend:true,lines:[
    ...
    {level:2,type:"Leyenda",title:"Qori Challwa",sub:"El pez de oro",legend:true,lines:[
    ...
    {level:2,type:"Leyenda",title:"Puma Orqo",sub:"El cerro del puma",legend:true,lines:[
    ...
    {level:2,type:"Cuento",title:"Achkay",sub:"La bruja de la montaña",legend:true,lines:[
    ...
    {level:2,type:"Leyenda",title:"Supay",sub:"El espíritu de las sombras",legend:true,lines:[
    ...
    {level:2,type:"Cuento",title:"Sirenita del Lago",sub:"La sirena del Titicaca",legend:true,lines:[
    ...
    {level:3,type:"Mito",title:"Inti Raymi",sub:"La fiesta del Sol",legend:true,lines:[
    ...
    {level:3,type:"Mito",title:"Ukuku",sub:"El hijo del oso y la mujer",legend:true,lines:[
    ...
    {level:3,type:"Leyenda",title:"Manco Qhapaq",sub:"El primer Inca",legend:true,lines:[
    ...
    {level:3,type:"Mito",title:"Viracocha",sub:"El dios creador",legend:true,lines:[
    ...
    {level:3,type:"Mito",title:"Qoyllur Riti",sub:"La estrella de la nieve",legend:true,lines:[
  ...
  ensayos:{title:"Textos cortos",color:"#fb7185",pieces:[
    {level:1,type:"Filosofía",title:"Ayni",sub:"La reciprocidad andina",essay:true,paras:[
    ...
    {level:2,type:"Cultura",title:"Música andina",sub:"Sonidos del alma",essay:true,paras:[
    ...
    ],notes:[{t:"Tinya",d:"Tambor andino pequeño."},{t:"Charan",d:"Charango, instrumento hecho con caparazón de quirquincho."},{t:"Muyuriy",d:"Girar, rodear — movimiento ritual."}]},
    {level:2,type:"Filosofía",title:"Sumaq Kausay",sub:"El Buen Vivir",essay:true,paras:[
    ...
    {level:3,type:"Filosofía",title:"La Chakana",sub:"La cruz andina",essay:true,paras:[
    ...
    {level:3,type:"Historia",title:"El Quipu",sub:"Escritura en nudos",essay:true,paras:[
    ...
    {level:3,type:"Historia",title:"Tawantinsuyu",sub:"El Imperio de las Cuatro Regiones",essay:true,paras:[
