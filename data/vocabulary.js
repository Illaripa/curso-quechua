const PALABRAS_Q=[
  {cat:"Familia",q:"Mama",s:"Madre",col:"#fed7aa",note:"La madre, también tierra madre",ex:[
  ...
  {cat:"Familia",q:"Tayta",s:"Padre",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Wawa",s:"Bebé / hijo/a pequeño",col:"#fed7aa",note:"Bebé o niño pequeño",ex:[
  ...
  {cat:"Familia",q:"Ñaña",s:"Hermana (dicho por mujer)",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Tura",s:"Hermano (dicho por mujer)",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Wawqi",s:"Hermano (dicho por hombre)",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Pani",s:"Hermana (dicho por hombre)",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Awki",s:"Abuelo / anciano",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Quya",s:"Abuela / reina",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Kaka",s:"Tío (hermano de madre)",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Ipa",s:"Tía (hermana de padre)",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Churi",s:"Hijo (dicho por hombre)",col:"#fed7aa",ex:[
  ...
  {cat:"Familia",q:"Ususi",s:"Hija (dicho por hombre)",col:"#fed7aa",ex:[
  ...
  {cat:"Cuerpo",q:"Uma",s:"Cabeza",col:"#fca5a5",ex:[
  ...
  {cat:"Cuerpo",q:"Ñawi",s:"Ojo / cara / semilla",col:"#fca5a5",note:"Ñawi tiene múltiples significados según contexto",ex:[
  ...
  {cat:"Cuerpo",q:"Rinri",s:"Oreja",col:"#fca5a5",ex:[
  ...
  {cat:"Cuerpo",q:"Sinqa",s:"Nariz",col:"#fca5a5",ex:[
  ...
  {cat:"Cuerpo",q:"Simi",s:"Boca / lengua / idioma",col:"#fca5a5",note:"Quechua simi = boca del quechua",ex:[
  ...
  {cat:"Cuerpo",q:"Qallu",s:"Lengua (dentro de boca)",col:"#fca5a5",ex:[
  ...
  {cat:"Cuerpo",q:"Kunka",s:"Cuello / garganta",col:"#fca5a5",ex:[
  ...
  {cat:"Cuerpo",q:"Makiy",s:"Mano / brazo",col:"#fca5a5",ex:[
  ...
  {cat:"Cuerpo",q:"Chakiy",s:"Pie / pierna",col:"#fca5a5",ex:[
  ...
  {cat:"Cuerpo",q:"Sonqo",s:"Corazón / mente / alma",col:"#fca5a5",note:"El sonqo es asiento de los sentimientos",ex:[
  ...
  {cat:"Cuerpo",q:"Kiru",s:"Diente / muela",col:"#fca5a5",ex:[
  ...
  {cat:"Cuerpo",q:"Wiksay",s:"Estómago / vientre",col:"#fca5a5",ex:[
  ...
  {cat:"Naturaleza",q:"Pacha",s:"Tierra / mundo / tiempo / universo",col:"#4ade80",note:"Concepto andino fundamental: espacio-tiempo",ex:[
  ...
  {cat:"Naturaleza",q:"Inti",s:"Sol",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Killa",s:"Luna / mes",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Quyllur",s:"Estrella",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Wayra",s:"Viento / aire",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Yaku",s:"Agua",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Nina",s:"Fuego",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Allpa",s:"Tierra / suelo",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Urqu",s:"Cerro / montaña",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Mayu",s:"Río",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Qucha",s:"Lago / mar",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Rumi",s:"Piedra / roca",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Sach'a",s:"Árbol",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"T'ika",s:"Flor",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Qura",s:"Hierba / planta",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Para",s:"Lluvia",col:"#4ade80",ex:[
  ...
  {cat:"Naturaleza",q:"Qasa",s:"Helada / escarcha",col:"#4ade80",ex:[
  ...
  {cat:"Animales",q:"Llama",s:"Llama",col:"#d9f99d",note:"Animal sagrado de los Andes",ex:[
  ...
  {cat:"Animales",q:"Alpaka",s:"Alpaca",col:"#d9f99d",ex:[
  ...
  {cat:"Animales",q:"Wik'uña",s:"Vicuña",col:"#d9f99d",ex:[
  ...
  {cat:"Animales",q:"Kuntur",s:"Cóndor",col:"#d9f99d",note:"Ave sagrada, mensajera del Apu",ex:[
  ...
  {cat:"Animales",q:"Puma",s:"Puma / leopardo",col:"#d9f99d",ex:[
  ...
  {cat:"Animales",q:"Atoc",s:"Zorro",col:"#d9f99d",ex:[
  ...
  {cat:"Animales",q:"Challwa",s:"Pez",col:"#d9f99d",ex:[
  ...
  {cat:"Animales",q:"Pisqu",s:"Pájaro",col:"#d9f99d",ex:[
  ...
  {cat:"Animales",q:"Waman",s:"Halcón",col:"#d9f99d",ex:[
  ...
  {cat:"Animales",q:"Allqu",s:"Perro",col:"#d9f99d",ex:[
  ...
  {cat:"Animales",q:"Michi",s:"Gato",col:"#d9f99d",ex:[
  ...
  {cat:"Comida",q:"Papa",s:"Papa / patata",col:"#86efac",note:"Originaria de los Andes",ex:[
  ...
  {cat:"Comida",q:"Chunu",s:"Chuño (papa deshidratada)",col:"#86efac",note:"Técnica ancestral de conservación",ex:[
  ...
  {cat:"Comida",q:"Sara",s:"Maíz",col:"#86efac",ex:[
  ...
  {cat:"Comida",q:"Quinua",s:"Quinoa",col:"#86efac",ex:[
  ...
  {cat:"Comida",q:"Kiwicha",s:"Amaranto andino",col:"#86efac",ex:[
  ...
  {cat:"Comida",q:"Chuqllu",s:"Choclo / maíz tierno",col:"#86efac",ex:[
  ...
  {cat:"Comida",q:"Oca",s:"Oca (tubérculo andino)",col:"#86efac",ex:[
  ...
  {cat:"Comida",q:"Kañiwa",s:"Cañihua (cereal andino)",col:"#86efac",ex:[
  ...
  {cat:"Comida",q:"Chicha",s:"Chicha (bebida fermentada de maíz)",col:"#86efac",ex:[
  ...
  {cat:"Comida",q:"Kanka",s:"Carne asada",col:"#86efac",ex:[
  ...
  {cat:"Colores",q:"Puka",s:"Rojo",col:"#fecaca",ex:[
  ...
  {cat:"Colores",q:"Q'umir",s:"Verde",col:"#fecaca",ex:[
  ...
  {cat:"Colores",q:"Anqas",s:"Azul",col:"#fecaca",ex:[
  ...
  {cat:"Colores",q:"Q'illu",s:"Amarillo",col:"#fecaca",ex:[
  ...
  {cat:"Colores",q:"Yuraq",s:"Blanco",col:"#fecaca",ex:[
  ...
  {cat:"Colores",q:"Yana",s:"Negro",col:"#fecaca",ex:[
  ...
  {cat:"Colores",q:"Oqe",s:"Gris",col:"#fecaca",ex:[
  ...
  {cat:"Colores",q:"Ankhu puka",s:"Naranja",col:"#fecaca",ex:[
  ...
  {cat:"Números",q:"Huk",s:"Uno (1)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Iskay",s:"Dos (2)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Kinsa",s:"Tres (3)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Tawa",s:"Cuatro (4)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Pichqa",s:"Cinco (5)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Suqta",s:"Seis (6)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Qanchis",s:"Siete (7)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Pusaq",s:"Ocho (8)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Isqon",s:"Nueve (9)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Chunka",s:"Diez (10)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Pachak",s:"Cien (100)",col:"#e0e7ff",ex:[
  ...
  {cat:"Números",q:"Waranqa",s:"Mil (1000)",col:"#e0e7ff",ex:[
  ...
  {cat:"Casa",q:"Wasi",s:"Casa / hogar",col:"#93c5fd",ex:[
  ...
  {cat:"Casa",q:"Punku",s:"Puerta",col:"#93c5fd",ex:[
  ...
  {cat:"Casa",q:"Kancha",s:"Recinto / patio cercado",col:"#93c5fd",note:"Kancha = espacio sagrado delimitado",ex:[
  ...
  {cat:"Casa",q:"Llaqta",s:"Pueblo / ciudad",col:"#93c5fd",ex:[
  ...
  {cat:"Casa",q:"Ayllu",s:"Comunidad familiar / clan",col:"#93c5fd",note:"Unidad social andina fundamental",ex:[
  ...
  {cat:"Casa",q:"Chakra",s:"Campo cultivado / chacra",col:"#93c5fd",ex:[
  ...
  {cat:"Casa",q:"Ñan",s:"Camino / sendero",col:"#93c5fd",note:"El Qhapaq Ñan es el gran camino inca",ex:[
  ...
  {cat:"Casa",q:"Chaka",s:"Puente",col:"#93c5fd",ex:[
  ...
  {cat:"Tiempo",q:"Kunan",s:"Ahora / hoy",col:"#fbbf24",ex:[
  ...
  {cat:"Tiempo",q:"Qayna",s:"Ayer / pasado",col:"#fbbf24",ex:[
  ...
  {cat:"Tiempo",q:"Paqarin",s:"Mañana (el día de mañana)",col:"#fbbf24",ex:[
  ...
  {cat:"Tiempo",q:"Wata",s:"Año",col:"#fbbf24",ex:[
  ...
  {cat:"Tiempo",q:"Killa",s:"Mes / luna",col:"#fbbf24",ex:[
  ...
  {cat:"Tiempo",q:"P'unchay",s:"Día",col:"#fbbf24",ex:[
  ...
  {cat:"Tiempo",q:"Tuta",s:"Noche",col:"#fbbf24",ex:[
  ...
  {cat:"Andino",q:"Pachamama",s:"Madre Tierra",col:"#c7d2fe",note:"Divinidad de la tierra en el mundo andino",ex:[
  ...
  {cat:"Andino",q:"Apu",s:"Espíritu de montaña sagrada",col:"#c7d2fe",note:"Entidad protectora que habita los cerros",ex:[
  ...
  {cat:"Andino",q:"Sumaq Kawsay",s:"Buen vivir / vida en plenitud",col:"#c7d2fe",note:"Filosofía andina de vida en armonía",ex:[
  ...
  {cat:"Andino",q:"Ayni",s:"Reciprocidad / trabajo comunitario",col:"#c7d2fe",note:"Principio andino: te doy lo que me diste",ex:[
  ...
  {cat:"Andino",q:"Minka",s:"Trabajo comunal colectivo",col:"#c7d2fe",note:"Todos trabajan juntos por el bien común",ex:[
  ...
  {cat:"Andino",q:"Hanan Pacha",s:"Mundo de arriba / cielo",col:"#c7d2fe",ex:[
  ...
  {cat:"Andino",q:"Kay Pacha",s:"Este mundo / mundo presente",col:"#c7d2fe",ex:[
  ...
  {cat:"Andino",q:"Uku Pacha",s:"Mundo de abajo / inframundo",col:"#c7d2fe",ex:[
  ...
  {cat:"Andino",q:"Yachaq",s:"Sabio / el que sabe",col:"#c7d2fe",ex:[
  ...
  {cat:"Andino",q:"Hampiq",s:"Curandero / sanador",col:"#c7d2fe",ex:[
  ...
  {cat:"Andino",q:"Sami",s:"Gracia / buena energía / suerte",col:"#c7d2fe",ex:[
  ...
  {cat:"Andino",q:"Kuyay",s:"Amor / afecto profundo",col:"#c7d2fe",note:"Amor que conecta al ser con todo",ex:[
  ...
  {cat:"Andino",q:"Qhapaq",s:"Poderoso / noble / generoso",col:"#c7d2fe",note:"Qhapaq Inka = el gran gobernante",ex:[
  ...
  {cat:"Andino",q:"Inti Raymi",s:"Fiesta del Sol (solsticio de junio)",col:"#c7d2fe",ex:[
